...
public class FuncionarioResource {
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
			@RequestBody FuncionarioDto funcionarioDto, BindingResult bindingResult) throws NoSuchAlgorithmException {

		log.info("Atualizando por ID: {}", funcionarioDto.toString());
