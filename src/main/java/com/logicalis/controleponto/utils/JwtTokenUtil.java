...
public class JwtTokenUtil {
	...
	static final String CLAIM_KEY_USERNAME = "sup";
	...
	userDetails.getAuthorities().forEach(authhority -> claims.put(CLAIM_KEY_ROLE, authhority.getAuthority()));
	claims.put(CLAIM_KEY_CREATED, new Date());
